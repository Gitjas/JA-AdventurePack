...
IF ~Global("JA#SILENCE_MASK","LOCALS",1)!InParty("TIAX")~ THEN REPLY @2 DO ~SetGlobal("JA#SILENCE_CH8","LOCALS",1) StartStore("JA#MASK1",LastTalkedToBy(Myself))~ JOURNAL @1032 EXIT
IF ~Global("JA#SILENCE_MASK","LOCALS",1)InParty("TIAX")~ THEN REPLY @2 DO ~SetGlobal("JA#SILENCE_CH8","LOCALS",1)~ JOURNAL @1032 GOTO JA#SILENC_3
