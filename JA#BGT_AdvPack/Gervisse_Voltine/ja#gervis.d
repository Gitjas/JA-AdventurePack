...
REPLACE_STATE_TRIGGER GERVIS 1 ~~

REPLACE_STATE_TRIGGER GERVIS 2 ~~

REPLACE_STATE_TRIGGER GERVIS 3 ~!Dead("Voltine")
Global("JA#GERVIS_QUEST","GLOBAL",1)~

REPLACE_STATE_TRIGGER GERVIS 4 ~~
...
IF ~~ THEN BEGIN JA_GERVIS_9
  SAY @28
  IF ~~ THEN DO ~SetGlobal("JA#GERVIS_QUEST","GLOBAL",11)~ EXIT
END

IF WEIGHT #-1
~Global("JA#GERVIS_QUEST","GLOBAL",11)~ THEN BEGIN JA_GERVIS_10
  SAY @22
  = @28
  IF ~~ THEN EXIT
END
...
IF WEIGHT #-1
~GlobalGT("JA#GERVIS_QUEST","GLOBAL",0)Global("JA#VOLT_QUEST","GLOBAL",0)!Dead("Gervisse")~ THEN BEGIN JA_VOLTIN_1
  SAY @30
