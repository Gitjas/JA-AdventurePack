...
IF ~NumDeadLT("JA#HOUND",3)NumDeadGT("JA#HOUND",1)Global("JA#CUNIM","MYAREA",1)~ THEN BEGIN 0
  SAY @0
  IF ~~ THEN DO ~SetGlobal("JA#CUNIM","MYAREA",2)AddexperienceParty(120)~ JOURNAL @1 EXIT
END

IF ~NumDead("JA#HOUND",3)Global("JA#CUNIM","MYAREA",1)~ THEN BEGIN 1
  SAY @2 
